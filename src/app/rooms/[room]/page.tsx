...
const ROOM_DETAILS: Record<string, RoomNarrative> = {
  bedroom: {
    ...
    aiComparison:
      "Traditional bedroom design projects can quickly reach $5,000 or far more once consultation, furniture changes, and soft furnishings are included. AltorLab lets you preview your bedroom redesign from $9, which is useful when you want design clarity before committing to a bigger spend.",
    india:
      "For bedrooms, prioritize wardrobe planning, blackout curtains, and finishes that handle daily use. If the room is compact, use a lighter palette and keep circulation around the bed open. AI previews also help couples align on style before buying the biggest pieces.",
    faqs: [
      {
      ...
      {
        question: "What is the best layout for a small bedroom?",
        answer:
  ...
  "living-room": {
    ...
    india:
      "Living rooms benefit from durable upholstery, easy-clean surfaces, and storage that hides daily clutter fast. If you host often, prioritize flexible seating and a layout that keeps the entry and TV wall visually calm. AI previews help you compare these options without moving furniture physically.",
    faqs: [
      {
      ...
      {
        question: "Why is living room planning so important?",
        answer:
  ...
  kitchen: {
    intro:
      "Kitchen design is one of the hardest areas to visualize because utility matters as much as appearance. A kitchen can look attractive in isolation and still feel frustrating every day if workflow, storage, and counter space are wrong. Kitchens need to handle heavy daily use, water exposure, and often a mix of open and closed storage. AI kitchen redesign is valuable because it lets you see a new look before taking on one of the most expensive renovation categories in the home. Whether you want a refresh or simply a better color and finish direction, the preview reduces uncertainty early.",
    layouts: [
    ...
    aiComparison:
      "Kitchen projects often cross $5,000 quickly because cabinetry, countertops, hardware, backsplash, and appliances add up fast. AltorLab gives you a visual redesign direction from $9 so you can test style and layout thinking before starting expensive work.",
    india:
      "For kitchens, choose finishes that are easy to wipe, prioritize ventilation planning, and keep high-use items near the cooking zone. AI previews are useful for comparing light versus dark surfaces and for deciding whether open shelves actually suit your maintenance habits.",
    faqs: [
      {
      ...
      {
        question: "What kitchen layout works best in a small home?",
        answer:
  ...
  bathroom: {
    ...
    aiComparison:
      "A bathroom redesign can exceed $5,000 once tiles, fixtures, plumbing changes, and vanity work are involved. AltorLab provides an AI preview from $9, which is a smart first step when you want to validate the overall look before committing to expensive execution.",
    india:
      "For bathrooms, moisture resistance, anti-skid flooring, and practical storage matter as much as aesthetics. If the bathroom is small, use larger-looking tile patterns, better mirrors, and lighter tones to stretch the space visually. AI previews help you decide that quickly.",
    faqs: [
      {
      ...
      {
        question: "What matters most in bathroom design?",
        answer:
  ...
  "home-office": {
    ...
    india:
      "A successful home office should consider daylight glare, cable management, and whether the room also serves another purpose. AI previews help you test calm backdrops, smarter storage, and layout logic before you invest in custom furniture.",
    faqs: [
      {
      ...
      {
        question: "Is a dedicated home office worth redesigning?",
        answer:
  ...
  "kids-room": {
    intro:
      "A kids room has to evolve faster than almost any other space in the house. What works for a toddler can feel restrictive a few years later, and what delights a child today may become impractical once study needs, storage volume, and play patterns change. Kids rooms need to stay manageable for parents, fit into apartment-sized layouts, and sometimes support siblings sharing the same room. AI kids room redesign helps because it shows how a more organized, age-flexible setup would look before you buy beds, study desks, storage units, or wall decor. That makes it easier to aim for a room that feels fun without becoming chaotic.",
    layouts: [
      "Single bed plus study desk and wardrobe wall for school-age children.",
    ...
    india:
      "For kids rooms, prioritize durable finishes, rounded edges, washable fabrics, and storage that children can use independently. If siblings share the room, AI previews help you test whether bunk beds, a shared desk, or zone-based planning makes the most sense for the available size.",
    faqs: [
      {
      ...
      {
        question: "What matters most in a kids room?",
        answer:
...
export async function generateMetadata({ params }: RoomPageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `See AI ${roomData.name.toLowerCase()} redesign ideas, compare layouts and design costs, and preview your room from $9 with AltorLab.`,
    openGraph: {
  ...
  return (
    <main className="min-h-screen bg-slate-900 text-slate-300">
      ...
      <div className="mx-auto max-w-4xl space-y-12 px-4 py-14 sm:px-6 lg:px-8">
        <section>
          <h2 className="mb-4 text-2xl font-bold text-white">Popular {roomData.name.toLowerCase()} layouts</h2>
          <p className="mb-6 leading-8 text-slate-400">
            Most {roomData.name.toLowerCase()} redesigns succeed when layout decisions come first. Room size can be limited, so every bed, desk, sofa, vanity, or storage unit affects circulation. These layout patterns are common because they balance practicality with visual clarity.
          </p>
        ...
        <section>
          <h2 className="mb-4 text-2xl font-bold text-white">Room planning tips</h2>

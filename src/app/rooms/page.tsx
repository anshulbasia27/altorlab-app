...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      "Browse room-specific redesign ideas for American homes and see how AI can transform your room from $9.",
  ...
  twitter: {
    ...
    title: "AI Room Redesign by Room Type — Bedrooms to Kitchens | AltorLab",
    description:
      "Room-specific AI redesign ideas for American bedrooms, living rooms, kitchens, bathrooms, home offices, and kids rooms.",
  },
};
      ...
      <section className="border-b border-slate-800 bg-gradient-to-b from-slate-900 to-slate-950 py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg leading-relaxed text-slate-400">
            Explore room-specific inspiration for American homes, compare design problems by space, and jump into an AI redesign preview before spending on furniture, paint, or renovation.
          </p>
        </div>
      </section>
          ...
          >
            <div className="mb-5 flex flex-wrap items-center gap-3">
              ...
              <span className="rounded-full border border-slate-700 px-3 py-1 text-sm text-slate-400">
                Secondary Hindi label: {room.secondaryHindiLabel}
              </span>
            </div>
            <h2 className="mb-3 text-2xl font-semibold text-white">AI {room.name} Redesign</h2>
            <p className="mb-4 leading-relaxed text-slate-400">
              See layouts, planning tips, and common American-home challenges for the {room.name.toLowerCase()} before you redesign.
            </p>

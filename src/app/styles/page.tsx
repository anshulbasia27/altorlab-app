...
export const metadata: Metadata = {
  ...
  description:
    "Explore modern, Scandinavian, minimalist, industrial, and bohemian room design ideas, then redesign your own room with AI from $9.",
  openGraph: {
    title: "Interior Design Styles by Room — AI Redesign Ideas | AltorLab",
    description:
      "Browse 5 interior design styles and turn your room photo into an AI redesign in seconds.",
  ...
  twitter: {
    ...
    title: "Interior Design Styles by Room — AI Redesign Ideas | AltorLab",
    description:
      "Modern, Scandinavian, minimalist, industrial, and bohemian design ideas for your home.",
  },
};
      ...
      <section className="border-b border-slate-800 bg-gradient-to-b from-slate-900 to-slate-950 py-16 px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl text-center">
          ...
          <p className="mx-auto max-w-3xl text-lg leading-relaxed text-slate-400">
            Compare the most popular room design styles, understand the colors and furniture that define each look, and move from inspiration to AI redesign in a few clicks.
          </p>
        </div>
      </section>
        ...
        {STYLES.map((style) => (
          ...
          >
            ...
            <p className="mb-6 text-sm leading-6 text-slate-500">
              Best for homeowners who want {style.name.toLowerCase()} rooms that feel polished, practical, and easy to execute in apartments and rental homes.
            </p>
            <Link

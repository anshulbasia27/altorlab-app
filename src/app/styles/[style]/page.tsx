...
const STYLE_DETAILS: Record<string, StyleNarrative> = {
  modern: {
    ...
    india:
      "Modern design works best when it respects storage pressure and day-to-day maintenance. Use wipeable paints, laminates, and fabrics that handle daily wear better than delicate finishes. In apartments, a wall-mounted study ledge, shoe storage near the entry, and wardrobes with loft cabinets help maintain the clean modern look in real life. If you want the room to feel premium without a full renovation, swap heavy curtains for sleek sheers plus blackout layers, update warm-white lighting, and use neutral upholstery with darker base furniture to hide daily wear. The appeal is universal: a room that feels current, organized, and easy to live in.",
    faqs: [
      {
        question: "Is modern interior design good for small apartments?",
        answer:
  ...
  scandinavian: {
    ...
    india:
      "Scandinavian design works especially well in apartments that need more light and softness without major renovation. If the room has dark tiles or darker finishes, use pale rugs, off-white paint, and warm wood furniture to shift the mood. For warmer climates, choose cotton, linen-look fabrics, and breezier curtains so the room feels cool instead of layered in a heavy way. Storage remains essential, so combine the style’s open feel with practical closed cabinets for daily essentials. In family homes, a Scandinavian kids corner, study nook, or breakfast table can still look beautiful because the style supports functionality. The promise is universal: a room that feels brighter, friendlier, and easier to enjoy every single day.",
    faqs: [
      {
      ...
      {
        question: "Does Scandinavian style work in warm climates?",
        answer:
  ...
  industrial: {
    ...
    india:
      "Industrial design should be adapted for comfort, climate, and maintenance. If the room gets hot, balance dark walls with lighter curtains, better ventilation, and wood or fabric surfaces that soften the visual weight. Use laminates or textured finishes that mimic concrete and brick instead of relying on high-maintenance raw materials everywhere. In apartments, industrial style works well in kitchens, study corners, and bachelor pads because it feels modern without being generic. It is also renter-friendly if you use movable shelving, art, rugs, and lighting rather than permanent civil work. The style delivers the same promise: a room with personality, depth, and a more confident urban identity than generic showroom interiors.",
    faqs: [
      {
  ...
  bohemian: {
    intro:
      "Bohemian interior design is ideal for people who want their rooms to feel expressive, layered, and full of personality. Instead of strict rules, boho spaces grow from collected objects, handcrafted textures, meaningful colors, and relaxed furniture layouts. The style appeals to those who love textiles, artisanal materials, plants, and cultural color already play a strong role in home life. A bohemian room does not need expensive uniform furniture to feel finished. It needs balance between color, comfort, and individuality. AI room redesign is useful here because boho styling can be hard to imagine from swatches alone. Seeing your actual room transformed with warmer tones, layered fabrics, cane furniture, and plant life makes it easier to decide how bold or subtle you want the final outcome to be.",
    whatIs:
      "Bohemian design values freedom over perfection. It mixes textures, patterns, and influences in a way that feels curated by life rather than staged by a catalog. You may see rattan furniture next to upholstered seating, patterned cushions over plain bedding, woven pendants above wooden tables, and art collected from travel, craft fairs, or family homes. The room should feel lived in, not overplanned. That said, good bohemian design still has structure. Repeating a color family, keeping circulation comfortable, and using a few anchor pieces prevents the room from becoming messy. Boho design often feels naturally compatible because materials like cane, jute, ceramics, brass, and terracotta already sit comfortably within an eclectic design language.",
    palette:
    ...
    india:
      "Bohemian design is particularly adaptable because so many natural and handcrafted materials already fit the style. Woven cushions, rugs, cane lights, patterned bedding, brass accents, terracotta planters, and indoor plants all sit naturally inside a boho palette. If you live in a rental, use removable layers such as curtains, art, rugs, bedding, and lighting to create the look without renovation. In family homes, keep the room practical by choosing washable fabrics and using baskets or trunks for quick storage. Natural ventilation and lighter fabric choices help the room stay comfortable in warmer spaces. The emotional payoff is universal: a room that feels warm, personal, creative, and unmistakably yours.",
    faqs: [
      {
      ...
      {
        question: "Which materials suit bohemian interiors best?",
        answer:
...
export async function generateMetadata({ params }: StylePageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: `${styleData.name} interior design ideas. Explore colors, furniture tips, and AI-powered room redesign from $9 with AltorLab.`,
    openGraph: {
      title: `${styleData.name} Room Design — AI Interior Redesign $9 | AltorLab`,
      description: `Plan a ${styleData.name.toLowerCase()} room with AI. See palette, furniture, and design tips before you redesign.`,
  ...
  return (
    <main className="min-h-screen bg-slate-900 text-slate-300">
      ...
      <div className="mx-auto max-w-4xl space-y-12 px-4 py-14 sm:px-6 lg:px-8">
        ...
        <section>
          <h2 className="mb-4 text-2xl font-bold text-white">Practical tips for {styleData.name.toLowerCase()} interiors</h2>
          <p className="leading-8 text-slate-400">{details.india}</p>
        </section>

...
export const STYLES: SeoStyle[] = [
  {
    ...
    indiaNote: "works especially well in apartments where you want to soften hard surfaces with matte textures and warm wood",
  },
  {
    slug: "scandinavian",
    name: "Scandinavian",
    ...
    indiaNote: "is ideal for compact homes because light colours reflect available daylight and make smaller rooms look calmer and larger",
  },
  {
    slug: "minimalist",
    name: "Minimalist",
    ...
    indiaNote: "helps families manage multi-use rooms by prioritising circulation, easy cleaning, and concealed storage over decorative excess",
  },
  {
    slug: "industrial",
    name: "Industrial",
    ...
    indiaNote: "pairs well with loft-style apartments or open-plan spaces where you want character without expensive civil changes",
  },
  {
    slug: "bohemian",
    name: "Bohemian",
    ...
    indiaNote: "feels naturally at home in eclectic interiors because it embraces craft, colour, layering, and handmade materials that add personality",
  },
];
...
export const ROOMS: SeoRoom[] = [
  {
    ...
    dimensions: "a typical living room of about 10x14 to 12x16 feet",
  ...
  },
  {
    ...
    dimensions: "most bedrooms between 10x12 and 11x14 feet",
    ...
    climate: "choose breathable fabrics, matte finishes, and closed storage to reduce dust and keep the room restful year-round",
  },
  {
    slug: "kitchen",
    name: "Kitchen",
    ...
    dimensions: "many kitchens fall in the 7x10 to 8x12 feet range",
    ...
    climate: "humidity, grease, and oil splatter make low-maintenance finishes far more valuable than delicate surfaces in kitchens",
  },
  {
    slug: "bathroom",
    name: "Bathroom",
    ...
    dimensions: "common bathrooms range from 5x7 to 6x8 feet",
    ...
    climate: "proper exhaust, stain-resistant grout, and moisture-friendly finishes matter more than trendy details in bathrooms",
  },
  {
    slug: "home-office",
    name: "Home Office",
    ...
    climate: "heat buildup from devices is common, so ventilation, blinds, and lighter finishes make long work hours easier",
  },
  {
    slug: "kids-room",
    name: "Kids Room",
    ...
    dimensions: "many kids rooms are about 9x10 to 11x12 feet",
    ...
    climate: "easy-clean finishes and durable storage matter because kids rooms handle high daily use",
  },
];
